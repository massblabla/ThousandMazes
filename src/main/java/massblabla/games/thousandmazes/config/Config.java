...
package massblabla.games.thousandmazes.config;
...
public class Config {
	...
	private long fpsCap = toml.getLong("fpsCap");
	...
	public long getFPSCap() { return fpsCap; }
	...
	public void setFPSCap(long in) { fpsCap = in; }
}
