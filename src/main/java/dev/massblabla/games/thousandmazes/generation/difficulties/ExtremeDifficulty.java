...
/**
 * Class for the VeryHardDifficulty difficulty
 *
 * @version 0.0.1-SNAPSHOT
 * @author massblabla
 */
public class ExtremeDifficulty extends Difficulty {
    public ExtremeDifficulty() {
        mazeWidth = 500;
        mazeHeight = 500;
        monsterSpawningLevel = 0.4d;
        totalLives = -1;
        debugOnly = false;
        difficulty = WorldDifficulties.EXTREME;
    }
}
