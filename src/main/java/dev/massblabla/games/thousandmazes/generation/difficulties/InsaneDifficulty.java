...
/**
 * Class for the Insane difficulty
 *
 * @version 0.0.1-SNAPSHOT
 * @author massblabla
 */
public class InsaneDifficulty extends Difficulty {
    public InsaneDifficulty() {
        mazeWidth = 300;
        mazeHeight = 300;
        monsterSpawningLevel = 0.35d;
        totalLives = -1;
        debugOnly = false;
        difficulty = WorldDifficulties.INSANE;
    }
}
