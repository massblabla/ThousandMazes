...
/**
 * Class for the Debug Mode difficulty
 * Accessible in debug mode (--debug)
 *
 * @version 0.0.1-SNAPSHOT
 * @author massblabla
 */
public class DebugModeDifficulty extends Difficulty {
    public DebugModeDifficulty() {
        debugOnly = true;
        difficulty = WorldDifficulties.DEBUG_MODE;
    }
}
