 ...
 */
package dev.massblabla.games.thousandmazes.generation.difficulties.etc;

import dev.massblabla.games.thousandmazes.generation.difficulties.Difficulty;
import dev.massblabla.games.thousandmazes.generation.enums.WorldDifficulties;

/**
 * Class for the Custom difficulty
 * You can modify everything here, like Debug Mode,
 * Except how the world generates, whereas Debug Mode
 * allows for you to change tiles.
 *
...
public class CustomDifficulty extends Difficulty {
    public CustomDifficulty() {
        debugOnly = false;
        difficulty = WorldDifficulties.CUSTOM;
    }
}
