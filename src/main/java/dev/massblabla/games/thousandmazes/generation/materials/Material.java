 ...
 */
package dev.massblabla.games.thousandmazes.generation.materials;

import dev.massblabla.games.thousandmazes.generation.enums.WorldMaterials;

/**
 * Parent class for world materials. Different from tile materials.
 * Although world materials depend on tile materials.
 * See dev.massblabla.games.thousandmazes.generation.enums.WorldMaterials
 *
 * @version 0.0.1-SNAPSHOT
 * @author massblabla
 */
public class Material {
    /* Crucial variables for world materials */
    // TODO: Do tiles.
    int materialType; /* Its material number */
    protected boolean debugOnly;
    protected WorldMaterials material;
}
